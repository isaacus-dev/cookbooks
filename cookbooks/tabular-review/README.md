...
- `tabular-review.html` — a lightweight front end that lets users upload documents, review extracted entities in a table, add custom query columns, and inspect the underlying ILGS document in an inline viewer.
